...
s_idx = None
s_list = [0,0.5,0.5,0,0,0,0,0,0]
output_image = './amber-film2half3half' + '-2ep.jpg' # path to saved output img
...
checkpoint_model_dir = './med-film-checkpoints/' # path to folder where checkpoints of trained models will be saved
...
style_weight = 1e5 # weight for style-loss, default is 1e10
