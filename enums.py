...
#s_list = None
output_image = './film-test' + '-2ep.jpg' # path to saved output img
...
checkpoint_model_dir = './cond-checkpoints/' # path to folder where checkpoints of trained models will be saved
